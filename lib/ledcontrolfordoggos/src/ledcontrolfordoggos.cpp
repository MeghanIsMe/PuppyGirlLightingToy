...
void full_SystemLeds::MergeDeviceLeds(front_LedStrip strip1,front_LedStrip strip2)
{
	for (int i = 0; i < strip1.NUMLEDS; i ++)
	{
		if (strip2.p_objectLedArray[i] != CRGB::Black)
			strip1.p_objectLedArray[i] = strip2.p_objectLedArray[i];
	}
}
